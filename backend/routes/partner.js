...
const {addPartner,getPartner,deletePartner,getPartnerExcel,pdfOfPartner,updatePatner,exportPartnerCsv}= require('../controllers/partner') //Importing Vendor controller.
