export const BASE_URL = 'http://0a62-110-227-211-43.ngrok.io';
// export const ADD_DONOR_GET_PARENTS_URL = '/api/donor/parents';
// export const ADD_DONOR_URL = 'donor';
// export const ADD_DONOR_FUND_URL = 'donor/balance';
export const VIEW_DONER_ID_URL = `/api/donor/{id}`;
export const VIEW_RECEPT_URL ='/api/userReceipts/get-user ';
...
export const ADD_DONOR_URL = '/api/donor'
