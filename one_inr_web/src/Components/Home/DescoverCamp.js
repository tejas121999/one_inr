        ...
        <div className="container">
          ...
          <div className="card-deck mb-3">
            <div className="card">
              ...
              <div className="card-body">
                <Link to="/education_fee" onClick={scrollTop}>
                  <p className="card-title">Paying Children education fee</p>
                </Link>
                <p className="card-text">
                  All together we can help to sponsor a child the basic
                  education so that we can help each other and help ourselves to
                  shape the nation.
                </p>
              </div>
              <div className="container">
            ...
            <div className="card">
              ...
              <div className="card-body">
                <Link to="/sponsoring_stationary" onClick={scrollTop}>
                  <p className="card-title">
                    Sponsoring Stationary for Students
                  </p>
                </Link>
                <p className="card-text">
                  By sponsoring a child’s education you help to fulfil their
                  dreams but also help the parent who cannot afford to send
            ...
            <div className="card">
              ...
              <div className="card-body">
                <Link to="/feeding_pigeons" onClick={scrollTop}>
                  <p className="card-title">Feeding Pigeons Grains</p>
                </Link>
                <p className="card-text">
                  This is an initiative taken up by 1INR to raise awareness to
                  sponsor grains and water for hungry and thirsty birds
                </p>
              </div>
              <div className="container">
                <div
          ...
          <div className="card-deck mb-3">
            <div className="card">
              ...
              <div className="card-body">
                <Link to="/feed_cows" onClick={scrollTop}>
                  <p className="card-title">Feed Cows with grass of Love</p>
                </Link>
                <p className="card-text">
                  Feeding the hungry cows is a noble deed that help us to
                  increase our good karma thereby also invites us some good
                  luck.
                </p>
              </div>
              <div className="container">
