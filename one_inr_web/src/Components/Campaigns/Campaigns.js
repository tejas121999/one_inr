  ...
  return (
    <div>
      <div className="container">
        ...
        >
          <div className="col-6">
            <Link to="/sponsoring_books"><img src={TopImg_1} className="img-fluid rounded-start" /></Link>
          </div>
          <div className="col-6 text-left">
            <div className="card-body">
              <Link to="/sponsoring_books" className="card-title h2">Sponsoring Books for Students</Link>
