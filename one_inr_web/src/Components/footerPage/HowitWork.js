            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-12">
                        ...
                        <br />
                        <p>If you want to be a part for the improvement of your nearby and the society you live with, give your
                            <b>fundraising support</b>
                            by joining hands with One INR.
                        </p>
                        <br />
                        <p>
                            One INR being a
                            &nbsp;<b>charitable donation</b>
                            &nbsp;platform collects
                            <b>money donation</b>
                            plans and options to choose and select the amount of money you want to donate.
                            Our backend team attached with the concerned NGOs will make sure your contribution of money and care reaches in proper hand.
                        </p>
                        <br />
                        ...
                        <p>
                            You can choose and select any one of the given donation option to donate your money.
                            Decide the plan among the three and daily it will deduct that particular amount of money from your account on a yearly basis. In the end,
                            you can check and see what difference you created in someone’s life just by donating a single rupee in a day.
                        </p>
                        <br />
                        <p>
                            If not yearly you can choose the custom donation option to manually enter the amount you want to donate.
                            With this, you can donate your choice of money to the
